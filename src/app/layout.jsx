...
const RootLayout = ({ children }) => {
  ...
  return (
    <html id='__next' dir={direction} style={{fontFamily:'sans-serif'}}>
      <body className='flex is-full min-bs-full flex-auto flex-col' style={{fontFamily:'sans-serif'}}>{children}</body>
    </html>
  )
}
